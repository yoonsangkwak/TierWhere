...
class BlueTeamAdapter(
...
) : RecyclerView.Adapter<BlueTeamAdapter.ViewHolder>(), BlueTeamView {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        BlueTeamService(this).tryGetSummonerTier(summoner[position].player.summonerId, holder)
        ...
        holder.name.setOnClickListener {
            ...
            BlueTeamService(this).tryGetSummoner(summonerName)
        }
    }
    ...
    override fun getSummonerTierSuccess(response: BlueSummonerTier, holder: ViewHolder) {
    ...
    override fun getSummonerSuccess(response: BlueSummoner) {
